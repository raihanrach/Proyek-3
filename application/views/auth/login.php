				...
				<div class="left">
					<div class="content">
						...
						<form class="form-auth-small" method="post" action="<?= base_url('auth'); ?>">
							...
							<div class="bottom">
								<!-- <div class="text-center"><i class="fa fa-lock"></i> <a href="#">Forgot password?</a></div> -->
								<div class="text-center"><a href="<?= base_url('auth/registration') ?>">Register an Account</a></div>
							</div>
						</form>
					</div>
				</div>
